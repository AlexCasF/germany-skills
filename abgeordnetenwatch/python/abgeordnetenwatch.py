...
def print_root_help():
    print("""abgeordnetenwatch -- abgeordnetenwatch.de public transparency data
...
def print_help(path):
    ...
    if joined == "politicians dossier":
        print("""abgeordnetenwatch politicians dossier
...
""")
        ...
        print("""abgeordnetenwatch politicians search
...
def run_politician_source(argv):
    ...
    payload["warnings"] = standard_warnings()
    payload["nextActions"] = [
        f"abgeordnetenwatch politicians page --id {record.get('id')}",
        f"abgeordnetenwatch politicians dossier --id {record.get('id')}",
    ]
    emit(payload)
...
def run_politician_page(argv):
    ...
    payload["warnings"] = standard_warnings()
    payload["nextActions"] = [f"abgeordnetenwatch politicians dossier --id {record.get('id')}"]
    emit(payload)
...
def run_mandates_for_politician(argv):
    ...
    payload["warnings"] = standard_warnings()
    payload["nextActions"] = [f"abgeordnetenwatch sidejobs for-politician --id {ident}"]
    emit(payload)
