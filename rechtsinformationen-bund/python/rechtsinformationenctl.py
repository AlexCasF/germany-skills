...
APP_NAME = "rechtsinformationenctl"
...
def print_root_help():
    print("""rechtsinformationenctl -- official German federal legal information preview API
...
def print_help(path):
    if path == ["documents", "dossier"]:
        print("""rechtsinformationenctl documents dossier
...
""")
        ...
        print("""rechtsinformationenctl documents text
